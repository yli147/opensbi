...
/* SBI SSE Event IDs. */
enum sbi_sse_event_id {
	SBI_SSE_EVENT_LOCAL_RAS_0,
	SBI_SSE_EVENT_LOCAL_RAS_1,
	SBI_SSE_EVENT_LOCAL_RAS_RSVD = 0x00000100,
	SBI_SSE_EVENT_LOCAL_PMU,
	SBI_SSE_EVENT_LOCAL_ASYNC_PF,
	SBI_SSE_EVENT_LOCAL_DEBUG = 0x7fffffff,
	SBI_SSE_EVENT_GLOBAL_RAS = 0x80000000,
	SBI_SSE_EVENT_GLOBAL_RAS_RSVC = 0x80000100,
	SBI_SSE_EVENT_GLOBAL_DEBUG = 0xffffffff,
};
