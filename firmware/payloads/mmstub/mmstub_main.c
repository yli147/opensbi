...
void mmstub_main(unsigned long a0, unsigned long a1)
{
	...
	_SMM_ModuleInit =
		(void (*)(void *SharedBufAddress, void *SharedBufSize,
			  int64_t SharedCpuEntry, int64_t cookie))0x40C00000;
	...
	MmSharedBuffer.MmPayloadBootInfo.SpNsCommBufBase = 0x7FE00000;
	...
	printk("[mmstub] debug line: before _SMM_ModuleInit %x ### %x ### \n", _SMM_ModuleInit, MmSharedBuffer.MmPayloadBootInfo.SpStackBase);
